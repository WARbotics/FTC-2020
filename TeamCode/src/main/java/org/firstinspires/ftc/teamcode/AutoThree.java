...
@Autonomous(name="AutoThree", group="Exercises")
public class AutoThree extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory myTrajectory = drive.trajectoryBuilder(new Pose2d())
                ...
                .splineTo(new Vector2d(95, 25), Math.toRadians(0))
                .addTemporalMarker(1,()->{})
                ...
                .splineToConstantHeading(new Vector2d(95,0), Math.toRadians(90))

                .addDisplacementMarker(()->{
                    this.arm.down();
                })
                .splineTo(new Vector2d(55.1176,20.9126), Math.toRadians(75))
