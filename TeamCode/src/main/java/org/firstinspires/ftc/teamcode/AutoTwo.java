...
@Autonomous(name="AutoTwo", group="Exercises")
public class AutoTwo extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory myTrajectory = drive.trajectoryBuilder(new Pose2d())
                ...
                .splineTo(new Vector2d(75, 5), Math.toRadians(0))
                .addTemporalMarker(1,()->{})
                ...
                .splineToConstantHeading(new Vector2d(75,0), Math.toRadians(90))
                .splineTo(new Vector2d(58.1176,20.9126), Math.toRadians(75))

                .addTemporalMarker(7,()->{this.arm.down();})
                .addTemporalMarker(8, ()->{
                    this.hopper.resetPush();
                })
